...
<div class="card">
    <div class="card-body">
        ...
        <form method="POST" action="{{route('schedule.updateData')}}">
            @csrf
            <input type="hidden" name="inpID" value="{{$s->id}}">
            <div class="row mt-3">
                <div class="col-md-2">
                    <h6>Tanggal Awal</h6>
                </div>
            ...
            <div class="row">
                <div class="form-group col-md-2">
                    <input type="date" name="inpSDate" class="form-control" value="{{$s->start_date}}" required>
                </div>
                <div class="form-group col-md-2">
                    <input type="date" name="inpEDate" class="form-control" value="{{$s->end_date}}" required>
                </div>
            </div>
            ...
            <div class="form-group">
                <select class="form-control" id="exampleFormControlSelect1" name="inpType" required>
                    <option value="{{$s->type->id}}">{{$s->type->type}}</option>
                    @foreach ($type as $t)
            ...
            <div class="form-group">
                <select class="form-control" id="exampleFormControlSelect1" name="inpVendor" required>
                    <option value="{{$s->vendor->id}}">{{$s->vendor->name}}</option>
                    @foreach ($vendor as $v)
            ...
            <div class="form-group">
                <select class="form-control" id="exampleFormControlSelect2" name="inpStatus" required>
                    ...
                    @elseif( $s->status == 'On Progress')
                    <option value="{{$s->status}}">{{$s->status}}</option>
                    <option value="Scheduled">Scheduled</option>
                    <option value="Postponed">Postponed</option>
                    <option value="Executed">Executed</option>
                    @elseif($s->status == 'Postponed')
                    <option value="{{$s->status}}">{{$s->status}}</option>
                    <option value="Scheduled">Scheduled</option>
                    <option value="On Progress">On Progress</option>
                    <option value="Executed">Executed</option>
            ...
            <div>
                <h6>Daftar Aset yang Diperbaiki</h6>
            ...
            <div class="mt-3">
                <h6>Deskripsi</h6>
                <div class="form-group">
                    <textarea class="form-control" rows="3" name="inpDesc" placeholder="Tambahkan catatan disini..." required>{{$s->desc}}</textarea>
                </div>
            </div>
